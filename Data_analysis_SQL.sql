...
SELECT 
    ...
    (s1.order_quantity*s1.recipe_quantity)*(s1.ing_price/s1.ing_weight) AS ingredient_cot
FROM (SELECT 
	o.item_id,
    i.sku,
    i.item_name,
...
FROM
    ...
    LEFT JOIN shift sh ON sh.shift_id = sh.shift_id;
